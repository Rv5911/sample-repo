    ...
    <section className="feature-section max-[900px]:px-6 px-40">
      {features.map((feature, idx) => (
        <div
          ...
          style={{ alignItems: 'center', minHeight: '340px', marginBottom: '4rem' }}
        >
          <div className="feature-image" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', minWidth: 0 }}>
            <img
              src={feature.image}
              alt={feature.title}
              style={{ width: '100%', height: 'auto', borderRadius: '1.5rem', boxShadow: '0 4px 32px rgba(0,0,0,0.10)', objectFit: 'cover', maxHeight: '420px' }}
            />
          </div>
