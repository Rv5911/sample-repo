...
const FavouritesPage = () => {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-pink-50 to-pink-100 py-8 sm:py-12 px-2 sm:px-4">
      <div className="">
          ...
          <div className="grid grid-cols-6 xs:grid-cols-2 gap-4 sm:gap-8">
            {favorites.map(item => (
              <div key={item.id} className="bg-white rounded-xl shadow-lg p-4 sm:p-6 flex flex-col items-center relative w-full">
                ...
                <button
                  className="absolute top-2 sm:top-3 right-2 sm:right-3 p-2 rounded-full bg-red-100 hover:bg-red-200 text-red-500 transition"
